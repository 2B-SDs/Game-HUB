/**
 * @brief This file has the code and functions for hangman game
 * @file Hangman.h
 */
...
int Hangman()
{
	...
	scanf("%d", &ch);
	fgetc(stdin);
	///@return returns the character that is read as an integer.
	switch (ch)
	{
	case 1:;
		system("cls");
	...
	inputagain:
		...
		case 1:
			...
			/**
			 * @brief calling single finction from Singleplayer.h.
		...
		case 2:
			multi();
			///@brief calling single finction from Multiplayer.h
